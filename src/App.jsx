    ...
    <div className="min-h-screen bg-slate-900 text-slate-100 font-sans antialiased flex flex-col">
      ...
      <header className="bg-slate-950 border-b border-slate-800 px-6 py-4 flex flex-col md:flex-row justify-between items-center gap-4 shadow-lg shrink-0">
        ...
        <div className="flex flex-wrap gap-3 items-center text-sm">
          {/* Sesión activa (el acceso a la herramienta ya requiere estar logueado) */}
          {user && (
            <div className="flex items-center gap-2.5 bg-slate-900/80 border border-slate-800 pl-2 pr-3 py-1.5 rounded-2xl">
              ...
              <div className="text-xs leading-tight">
                ...
                <button onClick={onLogout} className="text-[10px] text-red-400 hover:text-red-300 hover:underline mt-0.5 block leading-none bg-transparent border-none p-0 cursor-pointer">
                  Cerrar sesión
                </button>
              </div>
            </div>
